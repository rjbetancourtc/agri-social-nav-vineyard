function RobotExperimentDashboard_V7_English_lidar_CorridorRows_Row4_Central_BushEnhanced_B1
% =========================================================================
% EXPERIMENTAL DASHBOARD V7.2 - SOCIAL AGRICULTURAL ROBOT
% =========================================================================
% V7.3 UPDATE:
...
cfg.methodCodes = {'M0','M1','M2','M3','M4','B1'};
cfg.methodNames = { ...
    'M0 - NavMesh Only', ...
    'M1 - Threshold Stop', ...
...
fig = figure( ...
    'Name','Experimental Dashboard V7.2 - Social Agricultural Robot', ...
    'NumberTitle','off', 'Color','w', ...
    'Position',[60 50 1500 850], ...
    'CloseRequestFcn',@closeFigure);

panel = uipanel(fig, ...
    'Title','Experimental control V7.2 (auto-save + fallback)', ...
...
methodMenu = uicontrol(panel,'Style','popupmenu', ...
    'String',cfg.methodNames, 'Value',6, ...
...
initAxes();
    ...
    function startAcquisition(~,~)
        ...
        addStatus('Acquisition started (V7.2 with fallback).');
    end
