...
public class TrajectoryTrail : MonoBehaviour
{
    ...
    {
        // Limpiar todos los puntos almacenados
        // de la corrida anterior.
        points.Clear();

        // Asegurar referencia al LineRenderer.
        ...
        // El siguiente punto será considerado
        // como el primer punto de una nueva trayectoria.
        hasLastPoint = false;

        // Eliminar referencia espacial residual.
        lastPoint = Vector3.zero;

        Debug.Log(
            "[TrajectoryTrail] Trayectoria limpiada | " +
